...
##### 18.2.6.1.1 运行时语义: Encode ( <var>string</var>, <var>unescapedSet</var> ) [#](http://www.ecma-international.org/ecma-262/7.0/#sec-encode)
...
##### 18.2.6.1.2 运行时语义: Decode ( <var>string</var>, <var>reservedSet</var> ) [#](http://www.ecma-international.org/ecma-262/7.0/#sec-decode)
...
<figure>
<figcaption>表 44 (Informative): UTF-8 编码</figcaption>
 <table>
   <tbody>
    <tr>
     <th>字符编码值</th>
...
*decodeURIComponent** 函数是 %decodeURIComponent% 内在对象。当以一个参数 **encodedURIComponent** 调用 **decodeURIComponent** 函数，将执行以下步骤：
 ...
 3. 返回 [Decode](http://www.ecma-international.org/ecma-262/7.0/#sec-decode)(<var>componentString</var>, <var>reservedURIComponentSet</var>)。
